...
if($sql_query = "SELECT * FROM members WHERE admin='1'")
{
	print <<<EOF
		<div class='card'>
				<div class='card-body'>
				<h5 class='card-title'>Thêm người dùng</h5>
		<form action="add_user.php?act=do" method="post">
			...
			<tr>
				<td>Tài khoản admin <font color='red'>(*)</font>:</td>
				<td><input class="form-control" type="text" name="admin" value=""></td>
			</tr>			
			<tr>
	...
	if (isset($_GET['act']) && $_GET['act'] == "do" )//fix  Undefined index
	{
		...
		// if($admin != '1' || $admin != '0'){
		// 	// print "<font color='red'><b>ERROR!!!<br>Quyền của tài khoản là 1 hoặc 0.</b></font> <a href='javascript:history.go(-1)'>Nhấp vào đây để quay trở lại</a>";
		// 	print $admin;
		// 	exit;			
		// }
		...
		echo "
			<div class='alert alert-success alert-dismissable'>
	                           	 	...
	                           	 	<strong>Thông báo:</strong> Tài khoản {$username} đã được tạo. <a href='./?CBHT=thoat'>Nhấp vào đây để đăng nhập</a>
	                  	</div>
		";}
	}
}else{
	echo "
		<div class='alert alert-danger alert-dismissable'>
        	<button type='button' class='close' data-dismiss='alert'aria-hidden='true'>×</button>
       	 	<strong>Thông báo:</strong> Tính năng này đã bị khóa.</a>
  		</div>
	";
}
