...
<head>
  ...
  <title><?php echo $TIEUDE;?></title>
	...
	<link rel="icon" type="image/png" href="img/64.svg">
...
<link href="../assets/css/fontGG.css" rel="stylesheet">
...
<header id="header" class="header fixed-top d-flex align-items-center header-scrolled">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="?CBHT=index" class="logo d-flex align-items-center">
  ...
  PRINT <<< EOF
        <li class='nav-item dropdown pe-3'>
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href='./suathongtin.php?CBHT=edit'>
            ...
            <li >
              <a class=" dropdown-item d-flex align-items-center" href='./?CBHT=signs'>
